<!DOCTYPE HTML >
<!-- การค้นหาจากรหัสนักศึกษาเพื่อแก้ไขและลบ -->
<html>
 <head>
...
include("function.php");
 ...
 ?>
<center><br><h4>แบบฟอร์มแก้ไขข้อมูลนักศึกษา</h4><hr>
...
<input type="submit" value="ค้นหา">
 ...
 $sqlsearch="SELECT * FROM tblstudent WHERE std_id like '%$data%' ";
 //echo $sqlsearch;
 //รัน SQL
...
while($row=mysqli_fetch_assoc($result))
	...
	echo "<td><a href='editstd.php?std_id=$row[std_id]' class='btn btn-warning' role='button'>แก้ไข</a></td>";
	echo "<td><a href='deletestd.php?std_id=$row[std_id]' class='btn btn-danger' role='button' onclick='return warn();'>ลบ</a></td>";
	echo "</tr>";
	}
	echo "</table>";
	mysqli_close($conn);
