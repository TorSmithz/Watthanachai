<!DOCTYPE HTML >
<!-- การค้นหาจากคีย์เวิดของคำ-->
<html>
 <head>
  <title> searchstd.php </title>
  <meta charset="UTF-8">
...
<center><br><h4>แบบฟอร์มค้นหาข้อมูลนักศึกษา</h4><hr>
 <form action="searchstd3.php" method="POST">
 ต้องการค้นหา : <input type="text" name="data" required>
<input type="submit" value="ค้นหา">
 ...
 $sqlsearch="SELECT * FROM tblstudent WHERE std_id like '%$data%' or std_name like '%$data%' or std_address like '%$data%' or std_gender like '%$data%' ";
 //echo $sqlsearch;
 //รัน SQL
