<!DOCTYPE HTML >
<!-- การค้นหาวันเกิดจาก .... ถึง .... -->
<html>
 <head>
  <title> ค้นหาข้อมูลวันเกิดนักศึกษา </title>
  <meta charset="UTF-8">
...
include("function.php");
 ...
 ?>
<center><br><h4>แบบฟอร์มค้นหาข้อมูลวันเกิดนักศึกษา</h4><hr>
 <form action="searchstd5.php" method="POST">
 ค้นหาวันเกิดตั้งแต่ <input type="date" name="data" required>
  ถึง <input type="date" name="data2" required>
<input type="submit" value="ค้นหา">
 ...
 $sqlsearch="SELECT * FROM tblstudent WHERE std_birth between '$data' and '$data2' ";
 //echo $sqlsearch;
 //รัน SQL
